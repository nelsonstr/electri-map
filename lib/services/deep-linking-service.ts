...
export async function createShortLink(
  ...
  return {
    ...
    targetPath: data.target_path as string,
    targetParams: data.target_params as any[],
    code: data.code as string,
    title: data.title as string || undefined,
    description: data.description as string || undefined,
    utmSource: data.utm_source as string || undefined,
    utmMedium: data.utm_medium as string || undefined,
    utmCampaign: data.utm_campaign as string || undefined,
    expiresAt: data.expires_at as string || undefined,
    maxClicks: data.max_clicks || undefined,
    clickCount: data.click_count as number,
    uniqueClickCount: data.unique_click_count as number,
...
export async function getShortLink(shortLinkId: string): Promise<ShortLink | null> {
  ...
  return {
    ...
    createdBy: data.created_by || undefined,
    createdAt: data.created_at as string,
    lastClickedAt: data.last_clicked_at as string || undefined,
  }
}
...
export async function createDeepLinkConfig(
  ...
  return {
    ...
    requiredParams: data.required_params as any[],
    optionalParams: data.optional_params as any[],
    requiresAuth: data.requires_auth as boolean,
    requiresVerified: data.requires_verified as boolean,
    fallbackUrl: data.fallback_url as string || undefined,
