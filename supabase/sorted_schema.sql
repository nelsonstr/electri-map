...
('Public Works', 'PW', 'Infrastructure maintenance and repair', ARRAY['road_damage', 'sidewalks', 'public_lighting', 'traffic_signals']::issue_category[]),
('Utilities', 'UTIL', 'Water, electricity, and gas services', ARRAY['water_supply', 'electrical']::issue_category[]),
('Telecommunications', 'TELECOM', 'Internet and phone services', ARRAY['telecommunications']::issue_category[]),
('Sanitation', 'SAN', 'Waste management and cleaning', ARRAY['waste_management']::issue_category[]),
('Parks and Recreation', 'PARKS', 'Parks and recreational facilities', ARRAY['parks_recreation']::issue_category[]),
('Building Safety', 'BLDG', 'Building code enforcement', ARRAY['building_safety']::issue_category[]),
('Environmental Services', 'ENV', 'Environmental protection', ARRAY['environmental']::issue_category[])
